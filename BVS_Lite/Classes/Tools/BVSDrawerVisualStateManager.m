...
@implementation BVSDrawerVisualStateManager

+ (BVSDrawerVisualStateManager *)sharedManager {
    static BVSDrawerVisualStateManager *_sharedManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedManager = [[BVSDrawerVisualStateManager alloc] init];
